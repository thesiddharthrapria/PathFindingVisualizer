    ...
    return (
      ...
      <Router>
        ...
        <div id="top-bar" class="back-image">
          ...
          <a class="navbar-brand webName" href="#"><FontAwesomeIcon icon={faRoute}></FontAwesomeIcon> Shortest Path<br /> Visualizer</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="navbar-nav webBars">
                ...
                <li class="nav-item bar">
                  <a class="nav-link" target="_blank" href="https://github.com/thesiddharthrapria" rel="noreferrer"><FontAwesomeIcon icon={faDownload}></FontAwesomeIcon> Download</a>
                </li>
